...
<div id="main-content" class="px-4 py-4 main-content-desktop">
    ...
    <div class="card shadow p-4">
        ...
        <form id="formCreateUser" action="<?= base_url('superadmin/users/save') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <!-- Event Assignment: Sekarang digunakan untuk menugaskan Panitia/Korektor ke Event yang sudah ada -->
            <div class="mb-3" id="event-assignment-field">
                <label for="event_id" class="form-label">Tugaskan ke Event</label>
                <select class="form-select" id="event_id" name="event_id">
                    <option value="">-- Pilih Event (Wajib untuk Panitia/Korektor) --</option>
            ...
            <div class="d-flex justify-content-end mt-4">
                ...
                <button type="submit" class="btn btn-success">Daftarkan Akun</button>
            </div>
