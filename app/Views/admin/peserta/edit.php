...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><?= $title ?></h1>
    <a href="<?= base_url('admin/peserta') ?>" class="btn btn-secondary fw-medium">Kembali ke Daftar</a>
</div>
...
<div class="card shadow p-4">
    ...
    <form id="formEditPeserta" action="<?= base_url('admin/peserta/save') ?>" method="post">
        <?= csrf_field() ?>
